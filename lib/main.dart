...
import 'package:flutter_provider_with_models/auth.dart';
import 'package:flutter_provider_with_models/splashscreen.dart';
      ...
      providers: [
        ...
        ChangeNotifierProxyProvider<Auth, Products>(
            ...
            update: (ctx, value, previousProducts) => previousProducts
              ..getData(value.token, previousProducts.productsList)),
      ],
      child: MyApp(),
    ),
  );
    ...
    return Builder(
      builder: (innerContext) => FlatButton(
        onPressed: () {
          ...
          ).then((id) => Provider.of<Products>(context, listen: false)
              .delete(id, context));
        },
        child: Column(
          children: [
